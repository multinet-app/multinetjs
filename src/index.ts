...
class MultinetAPI {
  ...
  public async generateAltText(verbosity: string, explain: string, data: object, title?: string, level?: number): Promise<any> {
    return (await this.axios.generateAltText(verbosity, explain, data, title, level)).data;
  }
